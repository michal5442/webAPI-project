...
async function Register() {
    ...
    const postResponse = await fetch("https://localhost:44393/api/user/Register", {
        method: 'Post',
        headers: {
    ...
    const dataPost = await postResponse;
...
async function Login() {
    ...
    const postResponse = await fetch("https://localhost:44393/api/user/Login", {
        method: 'Post',
        headers: {
